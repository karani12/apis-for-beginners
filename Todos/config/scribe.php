...
return [
    ...
    'description' => 'This is a simple API for a TODO list with inclusive authentication and authorization. Go through the docs to figure out how to use the API.',
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve the token from the response headers after logging in.',
    ],
